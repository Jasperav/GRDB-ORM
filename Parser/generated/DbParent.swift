...
case .userUuid: return .userUuid
                ...
                public func update(entity: inout DbParent) {
                    switch self {
                        case .parentUuid(let value): entity.parentUuid = value
...
case let .userUuid(value):
                ...
                arguments += [self.parentUuid.uuidString]
...
public  
            func genUpdate(db: Database, column: UpdatableColumnWithValue, assertOneRowAffected: Bool = true) throws {
                switch column {
                    case .parentUuid(let val): try genUpdateParentUuid(db: db, parentUuid: val, assertOneRowAffected: assertOneRowAffected)
