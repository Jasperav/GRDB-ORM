...
case .firstName(let value): entity.firstName = value
case .jsonStruct(let value): entity.jsonStruct = value
case .jsonStructOptional(let value): entity.jsonStructOptional = value
case .jsonStructArray(let value): entity.jsonStructArray = value
case .jsonStructArrayOptional(let value): entity.jsonStructArrayOptional = value
case .integer(let value): entity.integer = value
case .bool(let value): entity.bool = value
case .serializedInfo(let value): entity.serializedInfo = try! entity.serializedInfo.serializedData()
case .serializedInfoNullable(let value): entity.serializedInfoNullable = try! entity.serializedInfoNullable?.serializedData()
                    }
                }
             }
public  
...
case let .serializedInfoNullable(value):
                ...
                arguments += [self.userUuid.uuidString]
...
case .firstName(let val): try genUpdateFirstName(db: db, firstName: val, assertOneRowAffected: assertOneRowAffected)
case .jsonStruct(let val): try genUpdateJsonStruct(db: db, jsonStruct: val, assertOneRowAffected: assertOneRowAffected)
case .jsonStructOptional(let val): try genUpdateJsonStructOptional(db: db, jsonStructOptional: val, assertOneRowAffected: assertOneRowAffected)
case .jsonStructArray(let val): try genUpdateJsonStructArray(db: db, jsonStructArray: val, assertOneRowAffected: assertOneRowAffected)
case .jsonStructArrayOptional(let val): try genUpdateJsonStructArrayOptional(db: db, jsonStructArrayOptional: val, assertOneRowAffected: assertOneRowAffected)
case .integer(let val): try genUpdateInteger(db: db, integer: val, assertOneRowAffected: assertOneRowAffected)
case .bool(let val): try genUpdateBool(db: db, bool: val, assertOneRowAffected: assertOneRowAffected)
case .serializedInfo(let val): try genUpdateSerializedInfo(db: db, serializedInfo: val, assertOneRowAffected: assertOneRowAffected)
case .serializedInfoNullable(let val): try genUpdateSerializedInfoNullable(db: db, serializedInfoNullable: val, assertOneRowAffected: assertOneRowAffected)
                }
            }
